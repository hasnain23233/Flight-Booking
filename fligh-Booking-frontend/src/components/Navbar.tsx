  ...
  return (
    <div className='p-3'>
      <ul className='space-y-3 font-semibold'>
        ...
        <li className="group flex items-center gap-3 p-3 rounded-lg text-gray-500 hover:bg-[#00B4ED] hover:text-white transition-colors duration-200 cursor-pointer">
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="w-5 h-5 shrink-0">
            <g clip-path="url(#clip0_34_13)">
              ...
              <path d="M5 1.875V3.125M15 1.875V3.125" stroke="#currentColor" strokeWidth="1.25" stroke-linecap="round" strokeLinejoin="round" />
              <path d="M18.125 6.25H1.875" stroke="currentColor" stroke-width="1.25" stroke-linejoin="round" />
            </g>
            <defs>
