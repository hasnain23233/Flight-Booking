...
const ClearIssued: React.FC = () => {
    const mockData = useBookingStore((state) => state.cleared);
                            ...
                            {paginatedData.length === 0 ? (
                                ...
                                paginatedData.map((b) => (
                                    <tr key={b.id} className="border-b hover:bg-gray-50">
                                        <td className="px-4 py-3 font-semibold text-[#FF9900]">{b.id}</td>
